...
// arc4random_buf is not provided by emscripten's musl-derived libc (probed:
// `wasm-ld: error: undefined symbol: arc4random_buf`). Mirroring the Linux
// arc4random_buf shim into an emscripten-rng-support.c is a possible
// follow-up; until then this test cannot link on emscripten.
